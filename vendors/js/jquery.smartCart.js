...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading">{product_name}</h4></p>',
        ...
        lang: { // Language variables
            ...
            subtotal: 'Subtotal:',
            cartRemove: 'X',
            cartEmpty: '¡No tienes ningún café en el carrito!<br />Elige un producto'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append('<div class="panel-heading sc-cart-heading">' + this.options.lang.cartTitle + ' <i class="bi bi-cart"></i></div>');
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case 'image':
                        ...
                        break;
                    default:
                        btnCheckout = '<button class="btn btn-primary sc-cart-checkout" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">' + this.options.lang.checkout + '</button> ';
                        break;
                }
        ...
        _addUpdateCartItem: function (p) {
            ...
            if (elmMain && elmMain.length > 0) {
                ...
                elmMain.append('<button type="button" class="sc-cart-remove"><i class="bi bi-x-circle"></i></button>');
